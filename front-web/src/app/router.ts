...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/review-items', component: () => import('@/features/practice/ReviewItemsPage.vue') },
    { path: '/mastered-items', component: () => import('@/features/practice/ReviewItemsPage.vue') },
    ...
    { path: '/admin/imports', component: () => import('@/features/admin/AdminImportsPage.vue') },
    { path: '/admin/imports/:importJobId', component: () => import('@/features/admin/AdminImportDetailPage.vue') },
    { path: '/admin/import-items/:importItemId', component: () => import('@/features/admin/AdminImportItemPage.vue') },
