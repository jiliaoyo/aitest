...
LEVEL_SCOPES = {
    "n5": "只生成初级基础表达：基本句型、助词、基础活用、时态、存在、比较、简单请求/许可/禁止、愿望与基础推量；禁止意志形、可能/被动/使役、复杂条件、～ために和高级书面表达。",
    "n4": "以 N5 为前提，加入常见条件、原因转折、先后、经验、目的、授受和基础敬语；禁止 N3 以上复杂复合句和使役被动。",
    "n3": "以 N4 为前提，加入复合句、间接表达、变化状态、可能/被动/使役和常见书面表达；禁止 N2/N1 高阶惯用句型。",
    "n2": "覆盖复杂从句、书面语、抽象语义、语气和正式表达；不要把 N1 特有的古雅、极正式或罕见固定句型当作常规范围。",
    "n1": "允许高级正式、书面、抽象和惯用表达，但每个知识点必须真实存在、可解释、可单独练习，不能生造句型。",
}
